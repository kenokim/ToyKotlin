...
<div class="container container-login col-md-4 p-3 h-100">
  ...
  <form @submit.prevent="postLoginForm">
    ...
    <button class="w-100 btn-secondary login-color p-2" type="submit">Log in</button>
    <button class="w-100 btn-primary google-login-color p-2" type="submit">Google Login</button>
    <button class="w-100 btn-primary github-login-color p-2" type="submit">Github Login</button>
    ...
    <p class="mt-5 mb-3 text-muted">&copy; 2022 Toy Project</p>
  </form>
</div>
</main>
